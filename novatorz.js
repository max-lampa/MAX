(function () {
  ...
  function posterHtml(item, cls) {
    ...
    var bar = progress > 0 ? '<div class="nova-tor-progress nova-tor-progress--' + (progress >= 90 ? 'done' : 'started') + '"><i style="width:' + progress + '%"></i><b>' + Math.round(progress) + '%</b></div>' : '';
     return '<div class="' + cls + '">' + fallback + '<img src="' + esc(url) + '" data-nova-tor-frame="' + esc(url) + '" decoding="async" onerror="this.classList.add(\'nova-tor-image--broken\')" />' + bar + '</div>';
  }
  ...
  var CSS = '' +
    ...
    '.nova-tor-modal__rowbody{min-width:0;flex:1}.nova-tor-modal__rowtitle{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.nova-tor-modal__rowmeta{font-size:.82em;opacity:.58;margin-top:.25em}.nova-tor-modal__score{font-variant-numeric:tabular-nums;opacity:.7}' +
     '.nova-tor-hero__badges{position:absolute;z-index:3;top:1.1em;right:1.2em;display:flex;flex-wrap:wrap;justify-content:flex-end;gap:.5em;max-width:62%;font-size:.9em}.nova-tor-hero__badge{display:inline-flex;align-items:center;gap:.45em;padding:.38em .62em;border:1px solid rgba(255,255,255,.42);border-radius:.45em;background:rgba(12,16,27,.68);color:#fff;box-shadow:0 .25em .8em rgba(0,0,0,.18);white-space:nowrap}.nova-tor-hero__badge b{font-size:1.08em;line-height:1}.nova-tor-hero__badge small{font-size:.72em;opacity:.8;line-height:1}.nova-tor-hero__badge--tmdb{border-color:#48a8ff;color:#8bc9ff}.nova-tor-hero__badge--imdb{border-color:#f0a34a;color:#ffc477}.nova-tor-hero__badge--kp{border-color:#f06b6b;color:#ff9b9b}.nova-tor-hero__badge--age{background:#dc4365;border-color:#ff7893}.nova-tor-hero__badge--status{background:#168c9a;border-color:#55d5d7}.nova-tor-hero__badge--quality{background:#168c76;border-color:#52d8b2}' +
    ...
    '.nova-tor__chip-value{overflow:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;min-width:0}' +
     '.nova-tor__best-poster,.nova-tor-card__poster,.nova-tor-modal__poster{overflow:hidden;background:linear-gradient(135deg,#344052,#202734);position:relative;flex-shrink:0}.nova-tor__best-poster img,.nova-tor-card__poster img,.nova-tor-modal__poster img{display:block;width:100%;height:100%;object-fit:cover;position:relative;z-index:1}.nova-tor-image--broken{display:none!important}.nova-tor__best-poster--fallback,.nova-tor-card__poster--fallback,.nova-tor-modal__poster--fallback{display:flex;align-items:center;justify-content:center;color:#9ce5ad}.nova-tor__best-poster--fallback-icon,.nova-tor-card__poster--fallback-icon,.nova-tor-modal__poster--fallback-icon{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;color:#9ce5ad;font-size:1.1em;opacity:.8}.nova-tor__best-body{position:relative}' +
