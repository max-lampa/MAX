(function () {
    ...
    function injectCSS() {
        ...
        style.innerHTML = `
            ...
            /* Дыхание постера — плавное приближение/отдаление на сфокусированной карточке */
            @keyframes ydesign-breath {
                0%   { transform: scale(1.00); }
                50%  { transform: scale(1.05); }
                100% { transform: scale(1.00); }
            }
            @keyframes ydesign-breath-horz {
                0%   { transform: scale(1.00); }
                50%  { transform: scale(1.035); }
                100% { transform: scale(1.00); }
            }
            body.ydesign-poster-breath .ydesign-active .card.focus .ydesign-img-layer.loaded {
                will-change: transform;
                animation: ydesign-breath 6s ease-in-out infinite;
                transform-origin: center center;
            }
            body.ydesign-poster-breath .ydesign-active .card.ydesign-horizontal.focus .ydesign-img-layer.loaded {
                animation: ydesign-breath-horz 7s ease-in-out infinite;
            }
    ...
    function applyDynamicCSS() {
        ...
        document.body.classList.toggle('ydesign-poster-breath', getSet('ydesign_poster_breath'));
    }
    ...
    function createSettings() {
        ...
        Lampa.SettingsApi.addParam({ component: 'ydesign', param: { name: 'ydesign_poster_breath', type: 'trigger', default: DefaultSettings.ydesign_poster_breath }, field: { name: 'Дыхание постера', description: 'Плавное приближение/отдаление постера на выбранной карточке' } });
