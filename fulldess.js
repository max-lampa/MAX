(function () {
    ...
    function injectCSS() {
        ...
        style.innerHTML = `
            ...
            .ydesign-active .card.focus .card__view {
                box-shadow: 0 0 0 3px rgba(255,255,255,0.92), 0 14px 36px rgba(0,0,0,0.72) !important;
            }
            ...
            body.ydesign-poster-breathing .ydesign-img-layer.loaded {
    ...
    function createSettings(retry) {
        ...
        Lampa.SettingsApi.addParam({ component: 'ydesign', param: { name: 'ydesign_poster_breathing', type: 'trigger', default: DefaultSettings.ydesign_poster_breathing }, field: { name: 'Дыхание постера', description: 'Плавное приближение и удаление постера/бэкдропа' } });
