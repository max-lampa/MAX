(function () {
    ...
    function injectCSS() {
        ...
        style.innerHTML = `
            ...
            /* ── Цветная рамка постера (цвет из плагина Colors → --main-color) ── */
            body.ydesign-card-border .ydesign-active .card .card__view {
                box-shadow: 0 0 0 var(--ydesign-cbw, 0.20em) var(--main-color, rgba(255,255,255,0.35)) !important;
            }
            body.ydesign-card-border .ydesign-active .card.focus .card__view {
                box-shadow: 0 0 0 var(--ydesign-cbw, 0.20em) var(--main-color, #fff),
        ...
        Lampa.Settings.listener.follow('change', function(e) {
            if(e.name.indexOf('ydesign_') !== -1) {
                ...
                var cssOnlyParams = [
                    ...
                    'ydesign_card_border', 'ydesign_card_border_width'
                ];
