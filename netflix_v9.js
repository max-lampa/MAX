    ...
    var CardProcessor = {
        ...
        processCard: function (card) {
            ...
            if (card.__nfx_key !== key) {
                card.__nfx_key = key;
                if (!card.__nfx_meta) this.clearBadge(card);
...
`;
    ...
    function bootstrap() {
        ...
        console.log('[NFX Premium] v9.0 — качество на постерах без блюра, hi-res постеры, нативное левое меню');
    }
