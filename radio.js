(function () {
    ...
    // ==================== ВСТРОЕННЫЙ СПИСОК СТАНЦИЙ (НА СЛУЧАЙ ОТСУТСТВИЯ ДОСТУПА К API) ====================
    var LOCAL_STATIONS = {
        "result": {
            "stations": [
                {
                    "id": 1,
                    "title": "Record Dance",
                    "tooltip": "Танцевальная музыка",
                    "stream": "https://air.radiorecord.ru:805/rcd_320",
                    "stream_128": "https://air.radiorecord.ru:805/rcd_128",
                    "stream_320": "https://air.radiorecord.ru:805/rcd_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2710/cover_mobile.jpg",
                    "genre": [{"id": 1, "name": "Dance"}]
                },
                {
                    "id": 2,
                    "title": "Record Club",
                    "tooltip": "Клубная музыка",
                    "stream": "https://air.radiorecord.ru:805/club_320",
                    "stream_128": "https://air.radiorecord.ru:805/club_128",
                    "stream_320": "https://air.radiorecord.ru:805/club_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2695/cover_mobile.jpg",
                    "genre": [{"id": 2, "name": "Club"}]
                },
                {
                    "id": 3,
                    "title": "Record Chill-Out",
                    "tooltip": "Расслабляющая музыка",
                    "stream": "https://air.radiorecord.ru:805/chil_320",
                    "stream_128": "https://air.radiorecord.ru:805/chil_128",
                    "stream_320": "https://air.radiorecord.ru:805/chil_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2709/cover_mobile.jpg",
                    "genre": [{"id": 3, "name": "Chill-Out"}]
                },
                {
                    "id": 4,
                    "title": "Record Deep",
                    "tooltip": "Deep House",
                    "stream": "https://air.radiorecord.ru:805/deep_320",
                    "stream_128": "https://air.radiorecord.ru:805/deep_128",
                    "stream_320": "https://air.radiorecord.ru:805/deep_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2703/cover_mobile.jpg",
                    "genre": [{"id": 4, "name": "Deep"}]
                },
                {
                    "id": 5,
                    "title": "Record Dubstep",
                    "tooltip": "Dubstep",
                    "stream": "https://air.radiorecord.ru:805/dub_320",
                    "stream_128": "https://air.radiorecord.ru:805/dub_128",
                    "stream_320": "https://air.radiorecord.ru:805/dub_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2711/cover_mobile.jpg",
                    "genre": [{"id": 5, "name": "Dubstep"}]
                },
                {
                    "id": 6,
                    "title": "Record Electronic",
                    "tooltip": "Электронная музыка",
                    "stream": "https://air.radiorecord.ru:805/el_320",
                    "stream_128": "https://air.radiorecord.ru:805/el_128",
                    "stream_320": "https://air.radiorecord.ru:805/el_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2704/cover_mobile.jpg",
                    "genre": [{"id": 6, "name": "Electronic"}]
                },
                {
                    "id": 7,
                    "title": "Record Future House",
                    "tooltip": "Future House",
                    "stream": "https://air.radiorecord.ru:805/fut_320",
                    "stream_128": "https://air.radiorecord.ru:805/fut_128",
                    "stream_320": "https://air.radiorecord.ru:805/fut_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2919/cover_mobile.jpg",
                    "genre": [{"id": 7, "name": "Future House"}]
                },
                {
                    "id": 8,
                    "title": "Record Goa",
                    "tooltip": "Goa Trance",
                    "stream": "https://air.radiorecord.ru:805/goa_320",
                    "stream_128": "https://air.radiorecord.ru:805/goa_128",
                    "stream_320": "https://air.radiorecord.ru:805/goa_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2713/cover_mobile.jpg",
                    "genre": [{"id": 8, "name": "Goa"}]
                },
                {
                    "id": 9,
                    ...
                    "tooltip": "Hardstyle",
                    "stream": "https://air.radiorecord.ru:805/hard_320",
                    "stream_128": "https://air.radiorecord.ru:805/hard_128",
                    "stream_320": "https://air.radiorecord.ru:805/hard_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2714/cover_mobile.jpg",
                    "genre": [{"id": 9, "name": "Hardstyle"}]
                },
                {
                    "id": 10,
                    "title": "Record Hip-Hop",
                    "tooltip": "Hip-Hop",
                    "stream": "https://air.radiorecord.ru:805/hip_320",
                    "stream_128": "https://air.radiorecord.ru:805/hip_128",
                    "stream_320": "https://air.radiorecord.ru:805/hip_320",
                    "bg_image_mobile": "https://www.radiorecord.ru/upload/stations/2715/cover_mobile.jpg",
                    "genre": [{"id": 10, "name": "Hip-Hop"}]
                }
            ],
            "genre": [
                {"id": 1, "name": "Dance"},
    ...
    // ==================== ОСНОВНОЙ КЛАСС API (С ПОДДЕРЖКОЙ ПРОКСИ И РЕЗЕРВНОГО СПИСКА) ====================
            ...
            value: function list() {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    _this.network["native"](_this.api_url, function (result) {
                        // Успешно загрузили – сохраняем в кеш и возвращаем
                        Lampa.Cache.rewriteData('other', 'radio_record_list', result)["finally"](function () {
                            resolve(result);
                        });
                    }, function () {
                        // Ошибка загрузки – пробуем взять из кеша Lampa
                        Lampa.Cache.getData('other', 'radio_record_list').then(function (cached) {
                            resolve(cached);
                        })["catch"](function () {
                            // Если кеша нет – используем встроенный список
                            console.log('Radio Record: используем локальный список станций');
                            resolve(LOCAL_STATIONS);
                        });
                    });
                });
            }
    ...
    // Используем публичный CORS-прокси вместо прямого URL
    _defineProperty(Api, "network", new Lampa.Reguest());
    _defineProperty(Api, "api_url", 'https://api.codetabs.com/v1/proxy?quest=https://www.radiorecord.ru/api/stations/');

    // ==================== КЛАСС ДЛЯ ИЗБРАННОГО (БЕЗ ИЗМЕНЕНИЙ) ====================
    ...
    // ==================== КОМПОНЕНТ LAMPA (БЕЗ ИЗМЕНЕНИЙ, КРОМЕ ВЫЗОВА API) ====================
    function Component() {
        var _this6 = this;
        var last, scroll, played,
            filtred = [],
            page = 0;
        ...
        this.create = function () {
            ...
            Api.list().then(function (result) {
                ...
                // В крайнем случае используем локальный список (уже есть в Api.list, но подстрахуемся)
                _this.data = LOCAL_STATIONS.result;
                filtred = _this.data.stations;
                _this.build();
            });
            return this.render();
