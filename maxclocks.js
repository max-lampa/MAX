    ...
    function createClock() {
        ...
        var clock = $([
            '<div id="custom-bubble-clock" style="display:flex; align-items:center; font-weight:900; margin-left:10px; z-index:100; pointer-events:none;">',
                '<div class="clock-unit" style="color:' + colorH + '; padding:2px 2px; margin:0; letter-spacing:1px;">00</div>',
                '<div id="clock-dots" style="color:' + colorD + '; margin:0 1px; font-weight:900; line-height:1;">:</div>',
                '<div class="clock-unit" style="color:' + colorM + '; padding:2px 2px; margin:0; letter-spacing:1px;">00</div>',
            '</div>'
        ].join(''));
