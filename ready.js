(function () {
    ...
    function injectCSS() {
        ...
        style.innerHTML = [
            ...
            ".ydesign-active .ydesign-card .card__vote { display: none !important; }",
             ...
             "    color: rgba(255,255,255,0.92); font-size: 0.9em; font-weight: 600;",
    ...
    function createSettings() {
        ...
        // Переводит подписи настроек, включая старые подписи в уже собранных
        // разделах. Технические ключи, названия API и значения параметров не меняются.
        var nativeAddParam = Lampa.SettingsApi.addParam;
        var ruWords = [
            [/Показувати/g, 'Показывать'], [/Відображати/g, 'Отображать'], [/Відображення/g, 'Отображение'],
            [/Показувати/g, 'Показывать'], [/Розмір/g, 'Размер'], [/Розміри/g, 'Размеры'], [/Кількість/g, 'Количество'],
            [/карток/g, 'карточек'], [/картки/g, 'карточки'], [/карток/g, 'карточек'], [/сітці/g, 'сетке'],
            [/Вертикальні/g, 'Вертикальные'], [/Горизонтальні/g, 'Горизонтальные'], [/Інші сторінки/g, 'Другие страницы'],
            [/Головна/g, 'Главная'], [/Логотипу/g, 'логотипа'], [/логотипів/g, 'логотипов'], [/назви/g, 'названия'],
            [/Додаткової назви/g, 'дополнительного названия'], [/додаткової назви/g, 'дополнительного названия'],
            [/Слогану/g, 'слогана'], [/слогану/g, 'слогана'], [/Опису/g, 'описания'], [/опису/g, 'описания'],
            [/Під карткою/g, 'под карточкой'], [/бейджів/g, 'бейджей'], [/Бейджів/g, 'Бейджей'], [/Бейджі/g, 'Бейджи'],
            [/Рейтинги/g, 'Рейтинги'], [/Рейтингів/g, 'Рейтингов'], [/Видимість/g, 'Видимость'], [/та/g, 'и'],
            [/Вирівнювання/g, 'Выравнивание'], [/Центрування/g, 'Выравнивание'], [/Відступи/g, 'Отступы'], [/Відступ/g, 'Отступ'],
            [/Відстань/g, 'Расстояние'], [/Значення/g, 'Значение'], [/Року/g, 'года'], [/Віку/g, 'возраста'],
            [/Сезонів/g, 'сезонов'], [/Серій/g, 'серий'], [/Жанри/g, 'Жанры'], [/Мови/g, 'Языки'], [/Якість/g, 'Качество'],
            [/постерів/g, 'постеров'], [/бекдропів/g, 'фонов'], [/Змінити вигляд/g, 'Изменить вид'], [/Активувати/g, 'Включить'],
            [/всередині/g, 'внутри'], [/Прибрати/g, 'Убрать'], [/Приховує/g, 'Скрывает'], [/розтягує/g, 'растягивает'],
            [/Показувати дату виходу/g, 'Показывать дату выхода'], [/Показувати студію озвучки/g, 'Показывать студию озвучки'],
            [/Показывать рейтинг/g, 'Показывать рейтинг'], [/Показывать длительность/g, 'Показывать длительность'],
            [/зверху ліворуч/g, 'сверху слева'], [/зверху праворуч/g, 'сверху справа'], [/знизу праворуч/g, 'снизу справа'],
            [/окремим рядком/g, 'отдельной строкой'], [/Введіть/g, 'Введите'], [/через кому/g, 'через запятую'],
            [/Тільки/g, 'Только'], [/Завжди/g, 'Всегда'], [/Українська/g, 'русский'], [/Укр/g, 'Рус'],
            [/Англ/g, 'англ'], [/Ориг/g, 'оригинал'], [/Залежить/g, 'Зависит'], [/Кольорова/g, 'Цветная'],
            [/Кольорові/g, 'Цветные'], [/Скляна підложка/g, 'Стеклянный фон'], [/Рамка/g, 'Рамка'], [/Форма/g, 'Форма'],
            [/Насиченість/g, 'Насыщенность'], [/Ленивая загрузка/g, 'Ленивая загрузка'], [/Завантажувати/g, 'Загружать'],
            [/тільки при появі/g, 'только при появлении'], [/на екрані/g, 'на экране'], [/Плагіну/g, 'плагина'], [/плагіну/g, 'плагина'],
            [/відступу/g, 'отступа'], [/Відстань/g, 'Расстояние'], [/відстань/g, 'расстояние'], [/між/g, 'между'],
            [/бейджами/g, 'бейджами'], [/по горизонталі/g, 'по горизонтали'], [/рядками/g, 'строками'],
            [/для блоку/g, 'для блока'], [/жанрів/g, 'жанров'], [/Ручний режим/g, 'ручной режим'],
            [/контенту знизу/g, 'контента снизу'], [/зверху/g, 'сверху'], [/назви\/лого/g, 'названия/логотипа'],
            [/та кеш/g, 'и кеш'], [/Ключі/g, 'Ключи'], [/і очищення/g, 'и очистка']
        ];
        function russianize(value) {
            if (typeof value !== 'string') return value;
            ruWords.forEach(function (pair) { value = value.replace(pair[0], pair[1]); });
            return value;
        }
        function translateSettings(value) {
            if (typeof value === 'string') return russianize(value);
            if (!value || typeof value !== 'object') return value;
            var result = Array.isArray(value) ? [] : {};
            Object.keys(value).forEach(function (key) { result[key] = translateSettings(value[key]); });
            return result;
        }
        Lampa.SettingsApi.addParam = function (param) {
            return nativeAddParam.call(this, translateSettings(param));
        };
        ...
        // -------------------------------------------------------------
        // ПОДКАТЕГОРИЯ 2: ВЕРТИКАЛЬНІ КАРТКИ (ydesign_vertical)
        // -------------------------------------------------------------
        ...
        // -------------------------------------------------------------
        // ПОДКАТЕГОРИЯ 3: ГОРИЗОНТАЛЬНІ КАРТКИ (ydesign_horizontal)
        // -------------------------------------------------------------
        ...
        // -------------------------------------------------------------
        // ПОДКАТЕГОРИЯ 7: API-КЛЮЧІ ТА КЕШ (ydesign_perf)
        // -------------------------------------------------------------
        Lampa.SettingsApi.addParam({
                ...
                if (currentSource !== 'tmdb' && currentSource !== 'cub') {
                    setTimeout(function () {
                        if (window.Lampa && Lampa.Noty) {
                            Lampa.Noty.show('Для работы «Русский дизайн» выберите источником TMDB или CUB (сейчас: ' + currentSource + ')');
                        }
                    }, 2500);
                }
            }
