 ...
 *
 * Всі тексти інтерфейсу переведені на російську мову.
 */
...
(function() {
    ...
    // Додаємо російські переклади для використовуваних міток
    Lampa.Lang.add({
        oscars_label: {
            uk: 'Оскар',
            ru: 'Оскар'
 ...
 `.trim();
    ...
    function cleanupRtgInjected(render) {
        if (!render || !render.length) return;
        render.find('.rate--mc, .rate--rt, .rate--popcorn, .rate--avg,' +
            '.rate--awards, .rate--emmy, .rate--oscars').remove();
    }
    ...
    function addLoadingAnimation() {
        ...
        var loaderHtml = '<div id="lmp-search-loader" class="loading-dots-container">' +
            '<div class="loading-dots__text">Поиск…</div>' +
        ...
        var fake = $('<div class="full-start-new__rate-line" ' +
    ...
    function lmpRatingsClearCache() {
        try {
            ...
            lmpToast('Кеш рейтингов очищен');
        } catch (e) {
            console.error('LMP Ratings: clear cache error', e);
            lmpToast('Ошибка очистки кеша');
        }
    }
    ...
    function fetchMdbListRatings(card, callback) {
        ...
        function handleSuccess(response) {
            ...
            function isUserSource(src) {
                return (src.indexOf('user') !== -1 || src.indexOf('users') !== -1 || src.indexOf('metacriticuser') !== -1 || src.indexOf('metacritic_user') !== -1);
            }
    ...
    function insertRatings(data) {
        ...
        (function() {
            ...
            if (!cont.length) {
                cont = $('<div class="full-start__rate rate--mc">' +
                    '<div>' + mcText + '</div>' +
        ...
        (function() {
            ...
            if (!cont.length) {
                cont = $('<div class="full-start__rate rate--rt">' +
                    '<div>' + rtText + '</div>' +
                    '<div class="source--name"></div>' +
                    '</div>');
        ...
        (function() {
            ...
            if (!cont.length) {
                cont = $('<div class="full-start__rate rate--popcorn">' +
                    '<div>' + pcText + '</div>' +
                    '<div class="source--name"></div>' +
                    '</div>');
    ...
    function addSettingsSection() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'API ключ (OMDb)',
                description: 'Введи свой ключ OMDb. Можно получить на omdbapi.com'
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                ...
                description: 'Введи свой ключ MDBList. Можно получить на mdblist.com'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Монохромный режим (Ч/Б логотипы)',
                description: 'Черно-белые логотипы рейтингов'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Рамка плиток рейтингов',
                description: 'Добавляет рамку вокруг каждой плитки (IMDb, Metacritic, Rotten, Popcorn, TMDB, AVG, Awards).'
            },
            onRender: function() {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Награды',
                description: 'Показывать Оскары, Эмми и другие награды.'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                ...
                description: 'Показывать средний рейтинг'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Размер логотипов рейтингов',
                description: 'Изменение высоты логотипов. \n"0" – стандарт, вводите от "1" или от "-1".'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Размер числа рейтинга',
                description: 'Изменение размера числа рейтинга и размера фона. \n"0" – стандарт, вводите от "1" или от "-1".'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Прозрачность фона под рейтингом',
                description: 'Прозрачность фона. Стандартное значение: "0.15". \n"0" – прозрачный, "1" – черный.'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Яркость плиток',
                description: 'Яркость плиток. \n"0" – черный. От 0 до 255 (напр. "50" - темно-серый).'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Отступы между блоками (шаг)',
                description: 'Дополнительный отступ. "0" – стандарт (0.3em). \nЧтобы увеличить - вводите от "1".'
            },
            onRender: function(item) {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Цветные оценки рейтингов',
                description: 'Цветное выделение оценок рейтингов'
            },
            onRender: function() {}
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'IMDb',
                description: 'Показывать/скрывать источник'
            }
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Дополнительные рейтинги на постере',
                description: 'Показывать имеющиеся и дополнительные рейтинги на постере'
            },
        });
