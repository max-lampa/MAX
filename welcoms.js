(function () {
    ...
    style.innerHTML = [
        '.welcome, .welcome__img, .lp-step, .lp-status, .welcome__logo, svg, .icon { display: none !important; opacity: 0 !important; pointer-events: none !important; visibility: hidden !important; }',
        ...
        '    background: url("' + customLogo + '") no-repeat center;',
    ...
    function triggerRemoval() {
        ...
        setTimeout(function() {
            ...
            if (myLoader) {
                ...
                setTimeout(function() { 
                    if (myLoader && myLoader.parentNode) {
