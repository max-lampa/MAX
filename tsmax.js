(function() { 'use strict';    
    ...
    var config = {    
        servers: [    
            {url: 'http://194.147.148.100:8090', title: 'server 1', available: false},    
            {url: 'http://45.144.53.25:37940', title: 'server 2', available: false},    
            {url: 'http://193.42.60.42:8090', title: 'server 3', available: false}    
        ],    
        checkTimeout: 10000,    
        enableLogging: true,    
