(function () {
    ...
    // =========================================================================
    var DefaultSettings = {
        // Apple TV-style vertical posters use a 2:3 ratio, not the old 9:16 crop.
        ydesign_card_type_main: 'horizontal',
        ydesign_card_type_other: 'vertical',
        ydesign_grid_items_v: '4',
        ...
        style.innerHTML = [
            ...
            "",
             ".ydesign-active .ydesign-card.focus .card__view {",
              "    outline: var(--ydesign-focus-width, 0.25em) solid var(--ydesign-focus-color, #ffffff) !important;",
            ...
            "    overflow: hidden;",
             ...
             "    transition: background-color 0.4s ease, outline-width 0.22s cubic-bezier(0.16, 1, 0.3, 1), outline-color 0.22s ease;",
            "}",
            "",
            ".ydesign-active .ydesign-card.ydesign-vertical .card__view { padding-bottom: 150% !important; } ",
             ".ydesign-active .ydesign-card.ydesign-horizontal .card__view { padding-bottom: 68.75% !important; } ",
            "",
            "@media (min-width: 769px) {",
            "    .ydesign-active .card.ydesign-vertical { width: calc(100% / var(--ydesign-grid-items-v, 4)); height: auto !important; }   ",
    ...
    function updateBorderStyles() {
        ...
        var css = '.ydesign-active .ydesign-card.focus .card__view{'
            + 'outline:' + focusWidth + 'em solid ' + focusColor + ' !important;'
            + 'outline-offset:0 !important;}';

        if (getSet('ydesign_card_border')) {
                css += 'body.ydesign-card-border .ydesign-card .card__view{'
                + 'outline:' + cardWidth + 'em solid ' + cardColor + ' !important;'
                + 'outline-offset:0 !important;}';
    ...
    function applyDynamicCSS() {
        try {
            ...
            document.body.classList.remove('ydesign-hide-left-column');
    ...
    function createSettings() {
        ...
        // -------------------------------------------------------------
         ...
         Lampa.SettingsApi.addParam({ component: 'ydesign_grid', param: { name: 'ydesign_card_type_main', type: 'select', values: { 'vertical': 'Вертикальные (2:3)', 'horizontal': 'Горизонтальные (16:11)' }, default: DefaultSettings.ydesign_card_type_main }, field: { name: 'Тип карточек (Главная)' } });
         Lampa.SettingsApi.addParam({ component: 'ydesign_grid', param: { name: 'ydesign_card_type_other', type: 'select', values: { 'vertical': 'Вертикальные (2:3)', 'horizontal': 'Горизонтальные (16:11)' }, default: DefaultSettings.ydesign_card_type_other }, field: { name: 'Тип карточек (Другие страницы)' } });
