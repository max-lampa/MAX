...
(function() {
  ...
  var posterRatingStyles = '<style>' +
    ...
    '.omdb-custom-rate{position:absolute;right:.4em;bottom:.4em;background:rgba(0,0,0,.75);color:#fff;padding:.2em .5em;border-radius:1em;display:flex;align-items:center;z-index:10;font-family:"Segoe UI",sans-serif;font-size:.9em;line-height:1;pointer-events:none;border:none;transition:box-shadow .2s,opacity .2s;}' +
  ...
  function pollPosterCards() {
    ...
    document.querySelectorAll('.card').forEach(function(card) {
      ...
      if (!customRateElement || customRateElement.dataset.omdbId !== ratingKey) {
        ...
        customRateElement.className = 'omdb-custom-rate';
