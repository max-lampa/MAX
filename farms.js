(function () {
    ...
    function applyStyles() {
        ...
        style.innerHTML = [
            ...
            '.color_square.default::before {' +
                ...
                'transform: rotate(-45deg) !important;' +
            '}',
            // Уменьшенные размеры квадратиков
            '.color_square {' +
            ...
            '.color-family-outline {' +
                ...
                'margin-bottom: 4px !important;' +  // уменьшено
                'backdrop-filter: blur(5px) !important;' +
            '}',
            '.color-family-name {' +
                'width: 70px !important;' +          // уменьшено
                'height: 38px !important;' +         // уменьшено
            ...
            '}',
            '.hex-input {' +
                'width: 180px !important;' +         // уменьшено для баланса
                'height: 45px !important;' +
                'border-radius: 16px !important;' +
            ...
            '.color-picker-container {' +
                ...
                'gap: 12px !important;' +            // уменьшено
                'padding: 5px !important;' +          // уменьшено
            '}',
            ...
            '}',
            // Новые стили для прокручиваемого контейнера
            '.color-picker-scroll {' +
    ...
    // Функція для створення HTML для вибору кольору (без HEX тексту)
    ...
    function openColorPicker() {
        ...
        var inputHtml = '<div class="color_square selector hex-input" tabindex="0" style="background-color: ' + hexValue + ';">' +
                        ...
                        '</div>';
        var topRowHtml = '<div style="display: flex; gap: 20px; padding: 0; justify-content: center; margin-bottom: 20px;">' +
        ...
        var modalContent = '<div class="color-picker-container">' +
                           ...
                           '<div>' + rightColumn + '</div>' +
                           '</div>';
        // Оборачиваем список цветов в прокручиваемый контейнер
        var scrollableContent = '<div class="color-picker-scroll">' + modalContent + '</div>';
        var modalHtml = $('<div>' + topRowHtml + scrollableContent + '</div>');
