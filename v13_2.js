    ...
    function initSettings() {
        ...
        var i18n = {
            'en': {
                ...
                'quality_pill': 'Pill',
                'quality_wide': 'Wide',
                'badge_padding': 'Badge Padding',
                'badge_font': 'Badge Font Size'
            },
            'uk': {
                'ps_title': 'Premium Style',
                ...
                'badge_padding': 'Размер паддинга',
                'badge_font': 'Размер шрифта'
            },
            'ru': {
                'ps_title': 'Premium Style',
        ...
        var prm = [
            ...
            { name: 'nfx_quality_size_pad', type: 'select', values: { '': t('auto'), '0px 2px': t('tiny'), '0px 4px': t('small'), '1px 6px': t('medium'), '2px 6px': t('large'), '3px 10px': t('xlarge') }, default: '', title: t('badge_padding') },
            { name: 'nfx_quality_size_font', type: 'select', values: { '': t('auto'), '0.40em': t('tiny'), '0.48em': t('small'), '0.55em': t('medium'), '0.62em': t('large'), '0.70em': t('xlarge') }, default: '', title: t('badge_font') },
