(function () {
     ...
     *  ✦ Focus          → только рамка, без вмешательства в раскладку
    ...
    function settingNumber(name, def, min, max) {
        var value = parseFloat(storeGet(name, def));
    ...
    function applyBodyFlags() {
        var b = document.body;
        if (!b) return;
        if (storeBool('nfx_hero_zoom', false) && !isExoticOS) b.classList.add('nfx-zoom');
    ...
    function injectCSS() {
        ...
        var posterScale = settingNumber('nfx_poster_size', 1, 0.85, 1.2).toFixed(2);
        var qualityBadgeScale = settingNumber('nfx_quality_badge_size', 1, 0.8, 1.25).toFixed(2);
...
:root {
    ...
    --nfx-poster-scale: ${posterScale};
    --nfx-quality-badge-scale: ${qualityBadgeScale};
    --nfx-radius: ${cardRad};
...
/* ================================================================
   2) CARD BASE — стабильная карточка без принудительного GPU-слоя
   ================================================================ */
...
.card__view {
    ...
    position: relative !important;
    transform: scale3d(var(--nfx-poster-scale), var(--nfx-poster-scale), 1) !important;
...
/* Свечение остаётся внутри скругления и не создаёт маску поверх постера */
.card__view::before {
    content: "" !important;
    ...
    box-shadow: inset 0 0 0 2px var(--nfx-accent-gl) !important;
    opacity: 0 !important;
    z-index: 2 !important;
...
/* Не трогаем маски других плагинов; отключаем только фильтры этого стиля */
.card .card__img,
...
.nfx-quality {
    opacity: 1 !important;
    transform: scale3d(var(--nfx-quality-badge-scale), var(--nfx-quality-badge-scale), 1) !important;
...
/* ================================================================
   3) CARD FOCUS — только рамка, без transform и сдвига соседей
   ================================================================ */
...
`;
    ...
    function initSettings() {
        ...
        var i18n = {
            'en': {
                ...
                'pq_orig': 'Maximum (original)',
                 'poster_size': 'Poster Display Size',
                 'ps_85': 'Smaller (85%)',
                 'ps_95': 'Slightly smaller (95%)',
                 'ps_100': 'Default (100%)',
                 'ps_110': 'Slightly larger (110%)',
                 'ps_120': 'Larger (120%)',
                 'quality_badge_size': 'Quality Badge Size',
                 'qb_80': 'Smaller (80%)',
                 'qb_100': 'Default (100%)',
                 'qb_125': 'Larger (125%)',
            ...
            'uk': {
                ...
                'pq_orig': 'Максимальна (original)',
                 'poster_size': 'Розмір постерів на екрані',
                 'ps_85': 'Менше (85%)',
                 'ps_95': 'Трохи менше (95%)',
                 'ps_100': 'За замовчуванням (100%)',
                 'ps_110': 'Трохи більше (110%)',
                 'ps_120': 'Більше (120%)',
                 'quality_badge_size': 'Розмір метки якості',
                 'qb_80': 'Менша (80%)',
                 'qb_100': 'За замовчуванням (100%)',
                 'qb_125': 'Більша (125%)',
            ...
            'ru': {
                ...
                'pq_orig': 'Максимальное (original)',
                 'poster_size': 'Размер постеров на экране',
                 'ps_85': 'Меньше (85%)',
                 'ps_95': 'Немного меньше (95%)',
                 'ps_100': 'По умолчанию (100%)',
                 'ps_110': 'Немного больше (110%)',
                 'ps_120': 'Больше (120%)',
                 'quality_badge_size': 'Размер метки качества',
                 'qb_80': 'Меньше (80%)',
                 'qb_100': 'По умолчанию (100%)',
                 'qb_125': 'Больше (125%)',
        ...
        var prm = [
            ...
            { name: 'nfx_poster_size', type: 'select', values: { '0.85': t('ps_85'), '0.95': t('ps_95'), '1': t('ps_100'), '1.1': t('ps_110'), '1.2': t('ps_120') }, default: '1', title: t('poster_size') },
            ...
            { name: 'nfx_quality_badge_size', type: 'select', values: { '0.8': t('qb_80'), '1': t('qb_100'), '1.25': t('qb_125') }, default: '1', title: t('quality_badge_size') },
            ...
            { name: 'nfx_hero_zoom', type: 'trigger', default: false, title: t('hero_zoom') },
