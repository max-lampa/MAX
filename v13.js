(function () {
    ...
    function injectCSS() {
        ...
        var qualityPad = qualityStyle === 'wide' ? '2px 6px' : (qualityStyle === 'pill' ? '1px 6px' : '0px 4px');
        var qualityRadius = qualityStyle === 'pill' ? '999px' : '3px';
        var qualityFont = qualityStyle === 'wide' ? '0.55em' : '0.48em';

        var qualityPadCustom = storeGet("nfx_quality_size_pad", "");
        var qualityFontCustom = storeGet("nfx_quality_size_font", "");
        if (qualityPadCustom) qualityPad = qualityPadCustom;
        if (qualityFontCustom) qualityFont = qualityFontCustom;
...
.card {
    position: relative !important;
    transition: transform 180ms var(--nfx-ease), z-index 0s !important;
    z-index: 1 !important;
...
`;
    ...
    function initSettings() {
        ...
        var prm = [
            ...
            { name: 'nfx_quality_size_pad', type: 'select', values: { '': 'Auto', '0px 2px': 'Tiny (0px 2px)', '0px 4px': 'Small (0px 4px)', '1px 6px': 'Medium (1px 6px)', '2px 6px': 'Large (2px 6px)', '3px 10px': 'XL (3px 10px)' }, default: '', title: 'Badge Padding' },
            { name: 'nfx_quality_size_font', type: 'select', values: { '': 'Auto', '0.40em': 'Tiny (0.40em)', '0.48em': 'Small (0.48em)', '0.55em': 'Medium (0.55em)', '0.62em': 'Large (0.62em)', '0.70em': 'XL (0.70em)' }, default: '', title: 'Badge Font Size' },
