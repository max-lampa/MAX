...
:root {
    ...
    --nfx-card-visual-scale: calc(var(--nfx-card-scale) * var(--nfx-poster-scale));
    --nfx-shift: 25%;
...
.card:hover {
    ...
    transform: scale3d(var(--nfx-card-visual-scale), var(--nfx-card-visual-scale), 1) !important;
}
...
.card.hover ~ .card,
.card:hover ~ .card {
    transform: translate3d(var(--nfx-shift), 0, 0)
               scale3d(var(--nfx-poster-scale), var(--nfx-poster-scale), 1) !important;
    z-index: 1 !important;
}
...
.card[data-nfx-edge="first"]:hover {
    ...
    transform: translate3d(var(--nfx-edge-nudge), 0, 0)
               scale3d(var(--nfx-card-visual-scale), var(--nfx-card-visual-scale), 1) !important;
}

.card[data-nfx-edge="first"].focus ~ .card,
.card[data-nfx-edge="first"].hover ~ .card,
.card[data-nfx-edge="first"]:hover ~ .card {
    transform: translate3d(calc(var(--nfx-shift) + var(--nfx-edge-nudge)), 0, 0)
               scale3d(var(--nfx-poster-scale), var(--nfx-poster-scale), 1) !important;
}
...
.card[data-nfx-edge="last"]:hover {
    ...
    transform: translate3d(calc(var(--nfx-edge-nudge) * -1), 0, 0)
               scale3d(var(--nfx-card-visual-scale), var(--nfx-card-visual-scale), 1) !important;
}
...
.card:hover ~ .card[data-nfx-edge="last"] {
    transform: translate3d(calc(var(--nfx-shift) * 0.5), 0, 0)
               scale3d(var(--nfx-poster-scale), var(--nfx-poster-scale), 1) !important;
}
