(function () {
    ...
    // ==================== ВСТРОЕННЫЙ СПИСОК СТАНЦИЙ (РАБОТАЕТ ВСЕГДА) ====================
    var LOCAL_STATIONS = {
        "result": {
            "stations": [
                {
    ...
    // ==================== ОСНОВНОЙ КЛАСС API (БЕЗ СЕТЕВЫХ ЗАПРОСОВ) ====================
    var Api = /*#__PURE__*/function () {
        ...
        _createClass(Api, null, [{
            key: "list",
            value: function list() {
                // Всегда возвращаем локальный список, без сетевых запросов
                return new Promise(function (resolve) {
                    console.log('Radio Record: используем локальный список станций (сетевые запросы отключены)');
    ...
    // Свойства Api больше не используются для сети, но оставим для совместимости
    _defineProperty(Api, "network", new Lampa.Reguest());
    _defineProperty(Api, "api_url", ''); // Не используется
    ...
    function Component() {
        ...
        this.create = function () {
            ...
            Api.list().then(function (result) {
                ...
                // На всякий случай подстрахуемся локальным списком
