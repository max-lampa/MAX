(function () {
  ...
  /* High-visibility red accent: deliberately kept as an override so the
     original skin layout and player integration remain untouched. */
  var ACCENT_CSS = [
    '@-webkit-keyframes nova-logo-flow{0%,100%{-webkit-filter:drop-shadow(0 0 .06em rgba(255,59,48,.9)) drop-shadow(0 0 .26em rgba(229,57,53,.55));filter:drop-shadow(0 0 .06em rgba(255,59,48,.9)) drop-shadow(0 0 .26em rgba(229,57,53,.55))}33%{-webkit-filter:drop-shadow(0 0 .08em rgba(255,107,97,.95)) drop-shadow(0 0 .32em rgba(255,59,48,.7));filter:drop-shadow(0 0 .08em rgba(255,107,97,.95)) drop-shadow(0 0 .32em rgba(255,59,48,.7))}66%{-webkit-filter:drop-shadow(0 0 .07em rgba(255,190,120,.95)) drop-shadow(0 0 .3em rgba(229,57,53,.64));filter:drop-shadow(0 0 .07em rgba(255,190,120,.95)) drop-shadow(0 0 .3em rgba(229,57,53,.64))}}',
    '@keyframes nova-logo-flow{0%,100%{filter:drop-shadow(0 0 .06em rgba(255,59,48,.9)) drop-shadow(0 0 .26em rgba(229,57,53,.55))}33%{filter:drop-shadow(0 0 .08em rgba(255,107,97,.95)) drop-shadow(0 0 .32em rgba(255,59,48,.7))}66%{filter:drop-shadow(0 0 .07em rgba(255,190,120,.95)) drop-shadow(0 0 .3em rgba(229,57,53,.64))}}',
    '@-webkit-keyframes nova-title-flow{0%,100%{background-position:0% 50%}50%{background-position:100% 50%}}',
    '@keyframes nova-title-flow{0%,100%{background-position:0% 50%}50%{background-position:100% 50%}}',
    '@-webkit-keyframes nova-hero-sweep{0%{background-position:140% 0}100%{background-position:-40% 0}}',
    '@keyframes nova-hero-sweep{0%{background-position:140% 0}100%{background-position:-40% 0}}',
    '@-webkit-keyframes nova-hero-glow{0%,100%{box-shadow:0 0 0 rgba(229,57,53,0),inset 0 0 0 rgba(229,57,53,0)}50%{box-shadow:0 0 1.4em rgba(229,57,53,.18),inset 0 0 1.2em rgba(229,57,53,.08)}}',
    '@keyframes nova-hero-glow{0%,100%{box-shadow:0 0 0 rgba(229,57,53,0),inset 0 0 0 rgba(229,57,53,0)}50%{box-shadow:0 0 1.4em rgba(229,57,53,.18),inset 0 0 1.2em rgba(229,57,53,.08)}}',
    '.nova-skin-root .nova-hero{border:1px solid rgba(255,59,48,.22);-webkit-animation:nova-hero-glow 6s ease-in-out infinite;animation:nova-hero-glow 6s ease-in-out infinite}',
    '.nova-skin-root .nova-hero:after{content:"";position:absolute;z-index:1;inset:0;pointer-events:none;background:linear-gradient(112deg,transparent 28%,rgba(255,107,97,.13) 45%,rgba(255,255,255,.07) 50%,transparent 64%);background-size:220% 100%;-webkit-animation:nova-hero-sweep 7s ease-in-out infinite;animation:nova-hero-sweep 7s ease-in-out infinite}',
    '.nova-skin-root .nova-hero__body{z-index:2}',
    '.nova-skin-root .nova-hero__title:not(.nova-hero__title--logo),.nova-skin-root .nova-hero__mark:not(.nova-hero__title--logo){background:linear-gradient(105deg,#fff 0%,#ff6b61 24%,#fff 46%,#ff3b30 72%,#fff 100%);background-size:220% auto;-webkit-background-clip:text;background-clip:text;color:transparent;-webkit-animation:nova-title-flow 5s ease-in-out infinite;animation:nova-title-flow 5s ease-in-out infinite;text-shadow:none}',
    '.nova-skin-root .nova-hero__title--logo>img{will-change:filter,transform;-webkit-animation:nova-logo-flow 5.5s ease-in-out infinite;animation:nova-logo-flow 5.5s ease-in-out infinite}',
    '.nova-skin-root .nova-hero__title--logo>img.nova-logo--invert{-webkit-animation-name:nova-logo-flow-invert;animation-name:nova-logo-flow-invert}',
    '@-webkit-keyframes nova-logo-flow-invert{0%,100%{-webkit-filter:invert(1) brightness(1.1) drop-shadow(0 0 .06em rgba(255,59,48,.9)) drop-shadow(0 0 .26em rgba(229,57,53,.55));filter:invert(1) brightness(1.1) drop-shadow(0 0 .06em rgba(255,59,48,.9)) drop-shadow(0 0 .26em rgba(229,57,53,.55))}50%{-webkit-filter:invert(1) brightness(1.25) drop-shadow(0 0 .1em rgba(255,190,120,.95)) drop-shadow(0 0 .34em rgba(255,59,48,.75));filter:invert(1) brightness(1.25) drop-shadow(0 0 .1em rgba(255,190,120,.95)) drop-shadow(0 0 .34em rgba(255,59,48,.75))}}',
    '@keyframes nova-logo-flow-invert{0%,100%{filter:invert(1) brightness(1.1) drop-shadow(0 0 .06em rgba(255,59,48,.9)) drop-shadow(0 0 .26em rgba(229,57,53,.55))}50%{filter:invert(1) brightness(1.25) drop-shadow(0 0 .1em rgba(255,190,120,.95)) drop-shadow(0 0 .34em rgba(255,59,48,.75))}}',
    '.nova-skin-root .nova-hero__title--logo>img.nova-logo--glow{-webkit-animation-name:nova-logo-flow;animation-name:nova-logo-flow}',
    '.nova-skin-root .nova-hero__meta .nova-badge{border:1px solid rgba(255,107,97,.5);box-shadow:0 0 .65em rgba(229,57,53,.28)}',
    '.nova-skin-root .nova-hero__progress{z-index:3;height:1.35em!important;background:rgba(92,16,24,.82)!important;box-shadow:0 0 .42em rgba(255,59,48,.62)}',
    '.nova-skin-root .nova-hero__progress .time-line>div{background:#ff3b30!important;box-shadow:0 0 .42em rgba(255,59,48,.95)}',
    '.nova-skin-root .nova-card__line{height:.38em!important;background:rgba(92,16,24,.68)!important}',
    '.nova-skin-root .nova-card__line .time-line>div,.nova-skin-root .nova-card__line--body .time-line>div{background:#ff3b30!important;box-shadow:0 0 .24em rgba(255,59,48,.78)}',
    '.nova-skin-root .nova-loading__bar>div{background:#ff3b30!important}',
    '.nova-skin-root .nova-btn.focus,.nova-skin-root .nova-btn:active,.nova-skin-root .nova-btn--main.focus,.nova-skin-root .nova-btn--main:active{background:#e53935!important;color:#fff!important;border-color:#ff6b61!important;box-shadow:0 .25em 1em rgba(229,57,53,.58)!important}',
    'body.nova-focus-ring .nova-skin-root .nova-btn--main{background:rgba(229,57,53,.34);color:#fff;border-color:#ff6b61}',
    '.nova-skin-root .selector.focus,.nova-skin-root .selector:active{background:#e53935!important;color:#fff!important;border-color:#ff6b61!important;box-shadow:0 .2em .85em rgba(229,57,53,.42)!important}',
    'button.focus,button:active,.button.focus,.button:active,.btn.focus,.btn:active{background:#e53935!important;color:#fff!important;border-color:#ff6b61!important;box-shadow:0 .2em .85em rgba(229,57,53,.42)!important}',
    '.modal,.modal__content,.modal__body,.modal__head,.modal__footer{border-color:rgba(255,59,48,.62)!important}',
    '.modal__content,.modal__body{background:linear-gradient(145deg,rgba(58,14,20,.98),rgba(24,11,16,.98))!important;box-shadow:0 .5em 2em rgba(229,57,53,.22)!important}',
    '.modal__head,.modal__title{color:#ff6b61!important}',
    '.modal .selector.focus,.modal .selector:active,.modal__item.focus,.modal__item:active,.modal__button.focus,.modal__button:active,.menu__item.focus,.menu__item:active,.selectbox__item.focus,.selectbox__item:active,.confirm__button.focus,.confirm__button:active{background:#e53935!important;color:#fff!important;border-color:#ff6b61!important;box-shadow:0 .2em .85em rgba(229,57,53,.5)!important}',
    '.modal__close.focus,.modal__close:active{background:#c62828!important;color:#fff!important}',
    ...
    '@media screen and (max-width:580px){.nova-skin-root .nova-hero__progress{height:1.05em!important}.nova-skin-root .nova-card__line{height:.34em!important}.nova-skin-root .nova-hero__title--logo>img{max-width:92%!important}}',
    '@media (prefers-reduced-motion:reduce){.nova-skin-root .nova-hero,.nova-skin-root .nova-hero:after,.nova-skin-root .nova-hero__title:not(.nova-hero__title--logo),.nova-skin-root .nova-hero__mark:not(.nova-hero__title--logo),.nova-skin-root .nova-hero__title--logo>img{animation:none!important;-webkit-animation:none!important}}'
  ].join('');
