...
function updateParamsVisibility(body) {
    ...
    for (var i = 0; i < params.length; i++) {
        ...
        for (var j = 0; j < elements.length; j++) {
            elements[j].style.display = displayValue;
        }
    }
    ...
    if (Lampa.SettingsApi) {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                ...
                localStorage.setItem('color_plugin_highlight_enabled', value);
                applyStyles();
                saveSettings();
                Lampa.Settings.render();
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function (value) {
                ...
                localStorage.setItem('color_plugin_dimming_enabled', value);
                applyStyles();
                saveSettings();
                Lampa.Settings.render();
            },
