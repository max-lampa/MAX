...
(function () {
    ...
    var I18N = {
        ...
        kino_add_channel_input:       { uk: 'Посилання на канал або @нік', ru: 'Ссылка на канал або @нік', en: 'Channel link or @handle', pl: 'Link do kanału lub @nazwa' },
    ...
    function KinoCard(data) {
        ...
        this.play = function (id) {
            ...
            // Built-in Lampa player — no buffering loader
        ...
        this.toggle = function () {
            ...
            Lampa.Controller.add('items_line', {
                toggle: function () {
                    ...
                    var focusEl = last || (items.length ? items[0].render()[0] : false);
                    Lampa.Controller.collectionFocus(focusEl, scroll.render());
                },
                right: function () { Navigator.move('right'); },
                left: function () { Navigator.move('left'); },
    ...
    function startPlugin() {
        ...
        $('body').append('<style id="kinooglad-css">' + [
            '.kino-card{width:calc(20% - 0.6em)!important;min-width:13em!important;max-width:17em!important;margin:0 0.6em 0.8em 0!important;aspect-ratio:16/9;display:inline-block!important;vertical-align:top;}',
            '@media(max-width:768px){.kino-card{width:calc(50% - 0.6em)!important;min-width:11em!important;max-width:unset!important;}}',
            ...
            Lampa.SettingsApi.addParam({
                ...
                onChange: function () {
                    Lampa.Input.edit({ title: tr('kino_add_channel_input'), value: '', free: true, nosave: true }, function (value) {
                        ...
                        if (!parsed) {
                            showMsg('Неверный формат. �?спользуйте @имя, ID канала UC... или ссылку YouTube', true);
                            return;
                        }
