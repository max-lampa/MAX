(function() {
    ...
    function applyTheme(theme, color) {
        ...
        var dynamicTheme = `
            ...
            /* Фокус-элементы с улучшенной тенью */
            .search-source.focus,
            .simple-button.focus,
            .menu__item.focus,
            .menu__item.traverse,
            ...
            .tag-count.selector.focus {
                ...
                color: #fff;
                box-shadow: 0 0 0.6em ${selectedColor}, 0 0 0.2em ${selectedColor}99;
                border-radius: 0.5em;
            ...
            .settings-param.focus {
                background: linear-gradient(to right, ${selectedColor}, ${selectedColor}cc);
                color: #fff;
                box-shadow: 0 0 0.6em ${selectedColor};
            ...
            @keyframes pulse {
                0% { transform: scale(1); box-shadow: 0 0 0 0 ${selectedColor}80; }
                70% { transform: scale(1.02); box-shadow: 0 0 0 0.8em ${selectedColor}00; }
                100% { transform: scale(1); box-shadow: 0 0 0 0 ${selectedColor}00; }
            }
            /* Рамки фокуса */
            ...
            .extensions__item.focus::after {
                ...
                box-shadow: 0 0 0.8em ${selectedColor}66;
                border-radius: 1em;
            }
            .head__action.focus,
            .head__action.hover {
            ...
            /* Кастомный скроллбар под цвет темы */
            ::-webkit-scrollbar {
                width: 8px;
                height: 8px;
            }
            ...
            .settings__content, .settings-input__content, .selectbox__content {
                background: rgba(20, 20, 20, 0.96);
            }
        `;
    ...
    function AddIn() {
        ...
        var style = `
            <style>
                ...
                .torrent-item, .online-prestige { transition: transform 0.3s ease; }
                ...
                .tag-count.focus, .full-person.focus, .full-episode.focus, .simple-button.focus,
                .full-start__button.focus, .items-cards .selector.focus, .card-more.focus,
                .explorer-card__head-img.selector.focus, .card-episode.focus, .card-episode.hover {
        ...
        if (Lampa.SettingsApi) {
            Lampa.SettingsApi.addComponent({
                ...
                name: Lampa.Lang.translate('Безопасный стиль'),
        ...
        function updateColorVisibility(theme) {
            ...
            theme === 'custom_color' ? colorParam.addClass('visible') : colorParam.removeClass('visible');
        }

        if (Lampa.SettingsApi) {
            Lampa.SettingsApi.addParam({
                component: 'safe_style',
                param: { name: 'safe_style_theme', type: 'select', values: { custom_color: 'Пользовательская', default: 'LAMPA' }, default: 'custom_color' },
                field: { name: Lampa.Lang.translate('Тема'), description: 'Выберите тему для интерфейса' },
            ...
            Lampa.SettingsApi.addParam({
                ...
                param: {
                    ...
                    values: {
                        ...
                        '#ffd700': 'Золотой',
                        '#e67e22': 'Морковный',
                        '#1abc9c': 'Бирюзовый (светлый)',
                        '#3498db': 'Голубой',
                        '#9b59b6': 'Лавандовый',
                        '#2ecc71': 'Изумрудный',
                        '#e74c3c': 'Коралловый',
                        '#f1c40f': 'Лимонный',
                        '#95a5a6': 'Серо-стальной',
                        '#d35400': 'Тыквенный',
                        '#c0392b': 'Бордовый'
                    },
                    default: '#c22222'
                },
                field: { name: Lampa.Lang.translate('Цвет темы'), description: 'Выберите цвет для пользовательской темы' },
                onChange: function(value) {
                    SafeStyle.settings.custom_color = value;
                    Lampa.Storage.set('safe_style_color', value);
                    Lampa.Settings.update();
                    if (SafeStyle.settings.theme === 'custom_color') applyTheme('custom_color', value);
                }
            });

            Lampa.SettingsApi.addParam({
                component: 'safe_style',
                param: { name: 'safe_style_button_styles_enabled', type: 'toggle', default: true },
                field: { name: Lampa.Lang.translate('Включить стили кнопок'), description: 'Управление стилями кнопок' },
                onChange: function(value) {
            ...
            Lampa.SettingsApi.addParam({
                component: 'safe_style',
                param: { name: 'safe_style_enabled', type: 'toggle', default: true },
                field: { name: Lampa.Lang.translate('Включить плагин'), description: 'Включить или выключить плагин тем' },
                onChange: function(value) {
        ...
        Lampa.Settings.listener.follow('open', function(e) {
            if (e.name === 'safe_style') updateColorVisibility(SafeStyle.settings.theme);
        });
    }
