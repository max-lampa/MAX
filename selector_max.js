(function () {
    ...
    var INTERFACE_PLUGINS = [
        {
            id: 'appletv_agnative',
            url: 'https://llowmikee.github.io/AppleTVAGNativeNG/appletv_agnative.js',
            status: 0,
            name: 'Apple TV AgNative',
            description: 'Стиль Apple TV'
        },
        {
            id: 'lampishemax',
            url: 'https://max-lampa.github.io/MAX/lampishemax.js',
            status: 0,
            name: 'StyleMax',
            description: 'Стиль карточек LampisheMax'
        },
        {
            id: 'slogostyle',
            url: 'https://max-lampa.github.io/MAX/slogostyle.js',
            status: 0,
            name: 'Logo Style',
            description: 'Стиль карточек Slogo'
        }
    ];
