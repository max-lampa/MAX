(function () {
  ...
  var TS_ROW_VERSION = 'no-source-tracker-v5';
  ...
  var styles = {
    ...
    // Стили для торрент-карточек
    '.torrent-item .ts-torrent-badges-row': {
      'display': 'flex',
      'align-items': 'center',
      'flex-wrap': 'wrap',
      'gap': '0.45em',
    ...
    '.online-prestige .ts-online-compat, .ts-torrent-badges-row .ts-online-compat': {
      'display': 'inline-flex',
      'align-items': 'center',
      'justify-content': 'center',
      'min-height': '1.7em',
    ...
    '.online-prestige .ts-online-compat.ts-compat-good, .ts-torrent-badges-row .ts-online-compat.ts-compat-good': {
      color: '#5cd4b0',
      'background-color': 'rgba(92, 212, 176, 0.12)',
      border: '0.15em solid rgba(92, 212, 176, 0.78)',
      'box-shadow': '0 0 0.45em rgba(92, 212, 176, 0.18)'
    },
    '.online-prestige .ts-online-compat.ts-compat-warn, .ts-torrent-badges-row .ts-online-compat.ts-compat-warn': {
      color: '#ffc371',
      'background-color': 'rgba(255, 195, 113, 0.12)',
      border: '0.15em solid rgba(255, 195, 113, 0.82)',
      'box-shadow': '0 0 0.45em rgba(255, 195, 113, 0.20)'
    },
    '.online-prestige .ts-online-compat.ts-compat-bad, .ts-torrent-badges-row .ts-online-compat.ts-compat-bad': {
      color: '#ff5f6d',
      'background-color': 'rgba(255, 95, 109, 0.14)',
    ...
    // HDR бейджи
    '.online-prestige .ts-hdr-badge, .ts-torrent-badges-row .ts-hdr-badge': {
      'display': 'inline-flex',
      'align-items': 'center',
      'justify-content': 'center',
      'min-height': '1.7em',
    ...
    '.online-prestige .ts-hdr-badge.ts-hdr-dv, .ts-torrent-badges-row .ts-hdr-badge.ts-hdr-dv': {
      color: '#d8a4ff',
    ...
    '.online-prestige .ts-hdr-badge.ts-hdr-hdr10plus, .ts-torrent-badges-row .ts-hdr-badge.ts-hdr-hdr10plus': {
      color: '#ffb347',
      'background-color': 'rgba(255, 179, 71, 0.14)',
      border: '0.15em solid rgba(255, 179, 71, 0.80)',
      'box-shadow': '0 0 0.55em rgba(255, 179, 71, 0.24)'
    },
    '.online-prestige .ts-hdr-badge.ts-hdr-hdr10, .ts-torrent-badges-row .ts-hdr-badge.ts-hdr-hdr10': {
      color: '#ffc371',
      'background-color': 'rgba(255, 195, 113, 0.12)',
      border: '0.15em solid rgba(255, 195, 113, 0.75)',
      'box-shadow': '0 0 0.45em rgba(255, 195, 113, 0.22)'
    },
    '.online-prestige .ts-hdr-badge.ts-hdr-hlg, .ts-torrent-badges-row .ts-hdr-badge.ts-hdr-hlg': {
      color: '#5cd4b0',
    ...
    // Аудио бейджи
    '.online-prestige .ts-audio-badge, .ts-torrent-badges-row .ts-audio-badge': {
      'display': 'inline-flex',
      'align-items': 'center',
      'justify-content': 'center',
      'min-height': '1.7em',
    ...
    '.online-prestige .ts-audio-badge.ts-audio-premium, .ts-torrent-badges-row .ts-audio-badge.ts-audio-premium': {
      color: '#ffc371',
    ...
    '.online-prestige .ts-audio-badge.ts-audio-dts, .ts-torrent-badges-row .ts-audio-badge.ts-audio-dts': {
      color: '#4db6ff',
      'background-color': 'rgba(77, 182, 255, 0.12)',
      border: '0.15em solid rgba(77, 182, 255, 0.78)',
      'box-shadow': '0 0 0.45em rgba(77, 182, 255, 0.20)'
    },
    '.online-prestige .ts-audio-badge.ts-audio-ac3, .ts-torrent-badges-row .ts-audio-badge.ts-audio-ac3': {
      color: '#a0b8d0',
      'background-color': 'rgba(160, 184, 208, 0.10)',
      border: '0.15em solid rgba(160, 184, 208, 0.55)'
    },
    '.online-prestige .ts-audio-badge.ts-audio-flac, .ts-torrent-badges-row .ts-audio-badge.ts-audio-flac': {
      color: '#5cd4b0',
      'background-color': 'rgba(92, 212, 176, 0.10)',
      border: '0.15em solid rgba(92, 212, 176, 0.72)'
    },
    '.online-prestige .ts-audio-badge.ts-audio-aac, .ts-torrent-badges-row .ts-audio-badge.ts-audio-aac': {
      color: '#43cea2',
      'background-color': 'rgba(67, 206, 162, 0.10)',
  ...
  function cleanupTorrentStyles() {
    try {
      ...
      document.querySelectorAll('.ts-online-torrent-row, .ts-online-source-row, .ts-torrent-badges-row').forEach(function (row) {
      ...
      document.querySelectorAll('.ts-online-torrent, .ts-online-source').forEach(function (card) {
        ...
        card.removeAttribute('data-ts-torrent-signature');
      });
  ...
  function tsCardBaseText(card) {
    ...
    try {
      card.querySelectorAll('.ts-online-torrent-row, .ts-online-source-row, .ts-torrent-badges-row').forEach(function (row) {
  ...
  function tsAdaptTorrentItems() {
    try {
      document.querySelectorAll('.torrent-item').forEach(function (item) {
        var title = tsText(item.querySelector('.torrent-item__title') ? item.querySelector('.torrent-item__title').textContent : '');
        var info = tsText(item.textContent);
        var full = tsText(title + ' ' + info);
        
        var signature = TS_ROW_VERSION + '|' + full;
        if (item.getAttribute('data-ts-torrent-signature') === signature) return;

        var oldRow = item.querySelector('.ts-torrent-badges-row');
        if (oldRow && oldRow.parentNode) oldRow.parentNode.removeChild(oldRow);

        var row = document.createElement('div');
        row.className = 'ts-torrent-badges-row';

        tsAppendCompatibility(row, full);
        tsAppendCodecBadges(row, full);
        tsAppendMovieBadges(row);

        if (row.children.length > 0) {
          var titleElement = item.querySelector('.torrent-item__title');
          if (titleElement && titleElement.parentNode) {
            titleElement.parentNode.insertBefore(row, titleElement.nextSibling);
            item.setAttribute('data-ts-torrent-signature', signature);
          }
        }
      });
    } catch (e) {
      console.error(config.name, 'ошибка адаптации торрент-элементов:', e);
    }
  }
  ...
  function init() {
    ...
    console.log(config.name, 'Плагин загружен, версия:', config.version, 'автор:', config.author);
  }
