(function() {
    ...
    hideLampaStyle.innerHTML = `
        ...
        .my-welcome-screen {
            ...
            background: #000000 url('https://i.postimg.cc/1tggDKFv/Max-a-Po-etomu-primeru-sde.png') no-repeat 50% 50%;
    ...
    if (!window.welcomeplugin) {
        ...
        var init = function() {
            ...
            // ГАРАНТОВАНИЙ ЧАС ПОКАЗУ: 7 секунд
            var minDisplayTime = 7000;
