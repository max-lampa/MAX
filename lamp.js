        ...
        var iv = setInterval(function () {
            ...
            if (logo) {
                if (logo.getAttribute('data-lampishe') !== '1') {
                    ...
                    logo.innerHTML = 'LAMP<span style="color: var(--lampishe-c2); -webkit-text-fill-color: var(--lampishe-c2); background: none;">!</span>SHE';
        ...
        return '' +
            '<div class="lampishe-preview" id="lampishe-preview">' +
                ...
                '<div class="lampishe-preview__info">' +
                    '<div class="lampishe-preview__logo">LAMP<span style="color:' + t.c2 + ';-webkit-text-fill-color:' + t.c2 + ';background:none;">!</span>SHE</div>' +
