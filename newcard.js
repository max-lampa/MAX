(function () {
    ...
    const PLUGIN_NAME = 'Новая карточка';
    ...
    function addSettings() {
        ...
        Lampa.SettingsApi.addParam({
            component: PLUGIN_ID,
            param: { name: 'cas_logo_quality', type: 'select', values: { 'w300':'300px', 'w500':'500px', 'original':'Оригинал' }, default: 'original' },
...
/* Оптимизация GPU для старых Android */
            ...
            if (event.type === 'complite') {  
                ...
                if (data && data.id) {
                    ...
                    const processImages = (res) => {
                        // Приоритет: русский, украинский, английский, любой
                        const bestLogo = res.logos.find(l => l.iso_639_1 === 'ru') || 
                                         res.logos.find(l => l.iso_639_1 === 'uk') || 
