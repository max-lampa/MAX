(function () {
  ...
  function rankVoices(buttons, sourceName, context) {
    ...
    return buttons.map(function (button, index) {
      ...
      return {
        ...
        score: score,
        isRussian: isRussianVoice(title)
      };
    }).sort(function (a, b) {
  ...
  // ИСПРАВЛЕННАЯ ФУНКЦИЯ: заменен только домен, логика путей сохранена
  function buildOnlineScriptUrl() {
    var token = '';
    // Заменен домен на http://bwa.ad/rc
    // ВАЖНО: Убедитесь, что по адресу http://bwa.ad/rc/online.js или http://bwa.ad/rc/online/js/... лежит валидный скрипт
