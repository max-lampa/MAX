(function () {
    ...
    function injectVoteButton(render, card) {
        ...
        /*
         * КЛЮЧЕВОЕ ИСПРАВЛЕНИЕ ДЛЯ TV:
         * После инъекции кнопки в DOM, контроллер Lampa уже захватил
         * список .selector-элементов и не знает о новой кнопке.
         * Вызов Controller.toggle('full') заставляет его пересканировать DOM.
         */
        setTimeout(function () {
            try {
