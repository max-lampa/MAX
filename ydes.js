(function () {
    ...
    function injectCSS() {
        ...
        style.innerHTML = [
            ...
            "    height: 1.15em !important; margin: 0 !important; z-index: 12 !important;",
             "    background: rgba(255, 255, 255, 0.22) !important; backdrop-filter: none !important; -webkit-backdrop-filter: none !important;",
    ...
    function createSettings() {
        ...
        var ruWords = [
            ...
            [/Показувати рейтинг/g, 'Показывать рейтинг'], [/Показувати тривалість/g, 'Показывать длительность'],
            ...
            [/Насиченість/g, 'Насыщенность'], [/Ліниве завантаження/g, 'Ленивая загрузка'], [/Завантажувати/g, 'Загружать'],
        ...
        var subSections = [
            ...
            { id: 'ydesign_perf', name: '⚙️ API-ключі та кеш', desc: 'Ключі OMDb/MDBList і очищення кешу плагіна' }
        ];
        ...
        // -------------------------------------------------------------
         Lampa.SettingsApi.addParam({ component: 'ydesign_grid', param: { name: 'ydesign_show_poster_caption', type: 'trigger', default: DefaultSettings.ydesign_show_poster_caption }, field: { name: 'Показывать надпись над постером', description: 'Показывать название фильма или сериала над постером' } });
         Lampa.SettingsApi.addParam({ component: 'ydesign_grid', param: { name: 'ydesign_lazy_load', type: 'trigger', default: DefaultSettings.ydesign_lazy_load }, field: { name: 'Ліниве завантаження', description: 'Завантажувати додаткові дані (логотипи, рейтинги) тільки при появі картки на екрані' } });
        ...
        // -------------------------------------------------------------
        // ПІДКАТЕГОРІЯ 7: API-КЛЮЧІ ТА КЕШ (ydesign_perf)
        // -------------------------------------------------------------
        Lampa.SettingsApi.addParam({
