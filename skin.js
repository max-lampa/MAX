(function () {
  ...
  /* High-visibility purple accent: deliberately kept as an override so the
     original skin layout and player integration remain untouched. */
  var ACCENT_CSS = [
    '.nova-skin-root .nova-hero__progress{height:1.15em!important;background:rgba(91,45,145,.72)!important;box-shadow:0 0 .35em rgba(168,85,247,.55)}',
    '.nova-skin-root .nova-hero__progress .time-line>div{background:#a855f7!important;box-shadow:0 0 .35em rgba(168,85,247,.9)}',
    '.nova-skin-root .nova-card__line .time-line>div,.nova-skin-root .nova-card__line--body .time-line>div{background:#a855f7!important;box-shadow:0 0 .2em rgba(168,85,247,.7)}',
    '.nova-skin-root .nova-loading__bar>div{background:#a855f7!important}',
    '.nova-skin-root .nova-btn.focus,.nova-skin-root .nova-btn--main.focus{background:#a855f7!important;color:#fff!important;box-shadow:0 .25em 1em rgba(168,85,247,.5)!important}',
    'body.nova-focus-ring .nova-skin-root .nova-btn--main{background:rgba(168,85,247,.28);color:#fff;border-color:#a855f7}',
