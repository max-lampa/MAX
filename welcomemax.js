(function () {
    ...
    style.innerHTML = [
        '.welcome, .lp-step, .lp-status, .welcome__img, img[src*="logo"] { display: none !important; opacity: 0 !important; pointer-events: none !important; visibility: hidden !important; }',
