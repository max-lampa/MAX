(function () {
    ...
    function initUltimateSettings() {
        ...
        add({
            component: 'new_interface',
            param: { name: 'ni_card_type', type: 'select', values: { horizontal: 'Широкие (Горизонтальные)', vertical: 'Стандартные (Вертикальные)' }, default: 'horizontal' },
            field: { name: 'Ориентация карточек', description: 'Формат постеров<br>(Изменение автоматически перезагрузит страницу)' },
        ...
        add({
            ...
            field: { name: 'Дизайн инфо-блока', description: 'Расположение текста в верхней части экрана.' },
        ...
        add({
            ...
            field: { 
                ...
                description: 'Указывайте значение в vh, em или px (например: 5vh или -2em).<br>По умолчанию: 0' 
            },
            onChange: function () {
        ...
        add({
            ...
            field: { name: 'Показывать продолжительность', description: 'Отображение длительности фильма' },
            onChange: applyDynamicStyles
        });
        ...
        add({
            ...
            field: { name: 'Логотипы на карточках', description: 'Показывать графические лого поверх постеров' },
            onChange: applyDynamicStyles
        });
        ...
        add({
            ...
            param: {
                name: 'ni_logo_lang',
                type: 'select',
                values: { '': 'Как в Lampa', en: 'English', uk: 'Українська', be: 'Беларуская', kz: 'Қазақша', pt: 'Português', es: 'Español', fr: 'Français', de: 'Deutsch', it: 'Italiano' },
                default: ''
            },
    ...
    function addStyleV3() {
        ...
        :root {
            --ni-logo-max-h-auto: 8.5em; /* Дефолтная высота в em */
        ...
        /* Высота инфо-блока в зависимости от ориентации карточек */
        ...
        body.ni-hide-captions .new-interface .card__view ~ .card__bottom { display: none !important; }
        ...
        /* --- КАРТОЧКИ: Горизонтальные vs Вертикальные --- */
        ...
        /* Раскладка 2 колонки (Flexbox для прижатия к правому краю) */
        ...
        body.ni-layout-1col .new-interface-info__description { max-width: 60%; } /* Уменьшено на четверть */
        ...
        /* Сдвиг строк вверх/вниз в зависимости от ориентации */
    ...
    // Запуск
    if (Lampa.Manifest.version >= '3.0.0') {
        startPluginV3();
    } else {
        startLegacyPlugin();
    }
