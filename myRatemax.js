(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            /* --- Кнопка «Оценить» ---
               Используем full-start__button — именно этот класс даёт
               тёмный скруглённый фон, как у всех нативных кнопок Lampa.
               Делаем чуть крупнее остальных по просьбе пользователя.    */
            '.view--lampa-vote{',
    ...
    function makeVoteBtn(card) {
         ...
         */
        /*
         * КЛЮЧЕВОЕ: используем full-start__button — именно этот класс
         * даёт тёмный скруглённый фон как у кнопок Play/Bookmark/More.
         * view--button НЕ даёт фон на TV-версии Lampa.
         * Структура: SVG + <span> — как в референсных плагинах Lampa.
         */
        var btn = $(
            '<div class="full-start__button view--lampa-vote selector"' +
